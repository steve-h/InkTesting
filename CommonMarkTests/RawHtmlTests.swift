...
"""#####
    ...
    func testExample613() {
        ...
        let html = MarkdownParser().html(from: markdownTest)
        let normalizedCM = #####"""
<p><a foo="bar" bam="baz <em>&quot;</em>" _boolean zoop:33="zoop:33"></a></p>
"""#####
        XCTAssertEqual(normalize(html: html),normalizedCM)
