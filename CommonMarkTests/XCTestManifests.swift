...
public func allTests() -> [Linux.TestCase] {
    return [
        ...
        Linux.makeTestCase(using: TablesExtensionTests.allTests),
        Linux.makeTestCase(using: TablesExtensionTests.allTests),
        Linux.makeTestCase(using: TablesExtensionTests.allTests),
        Linux.makeTestCase(using: TablesExtensionTests.allTests),
        Linux.makeTestCase(using: TablesExtensionTests.allTests),
        ...
        Linux.makeTestCase(using: TaskListItemsExtensionTests.allTests),
        Linux.makeTestCase(using: TaskListItemsExtensionTests.allTests),
        ...
        Linux.makeTestCase(using: StrikethroughExtensionTests.allTests),
        Linux.makeTestCase(using: StrikethroughExtensionTests.allTests),
        ...
        Linux.makeTestCase(using: AutolinksExtensionTests.allTests),
        Linux.makeTestCase(using: AutolinksExtensionTests.allTests),
        Linux.makeTestCase(using: AutolinksExtensionTests.allTests),
        Linux.makeTestCase(using: AutolinksExtensionTests.allTests),
        Linux.makeTestCase(using: AutolinksExtensionTests.allTests),
        ...
        Linux.makeTestCase(using: DisallowedRawHtmlExtensionTests.allTests),
